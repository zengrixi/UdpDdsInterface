...
void TestInfo(LHZS::SDI_TRACK_REPORT *pInstance)
{
    ...
    sTrackState
    << QString("platform_id_ul : %1\n").arg(pInstance->platform_id_ul)
    << QString("sdi_track_number_ul : %1\n").arg(pInstance->sdi_track_number_ul)
    ...
    << QString("target_geo_position.alt_f : %1\n").arg(pInstance->target_geo_position.alt_f)
    << QString("target_geo_position.lat_f : %1\n").arg(pInstance->target_geo_position.lat_f)
    << QString("target_geo_position.lon_f : %1\n").arg(pInstance->target_geo_position.lon_f)
